...
|训练参数|最终loss|训练时长|
| ------------- |:-------------:| -----:|
|dim=100, epoch=5|0.220873|30m|
|dim=100, epoch=15|0.086431|1h30m|
|dim=100, epoch=30|?|?|
|dim=200, epoch=5|0.220477|55m|
|dim=200, epoch=15|?|2h40m|
|dim=200, epoch=30|?|?|
|dim=300, epoch=5|0.222116|1h15m|
|dim=300, epoch=15|?|3h40m|
|dim=300, epoch=30|?|7h10m|
